...
const AddQuestion = (props) => {
  ...
  const [questionType, setQestionType] = useState("Trắc nghiệm nhiều đáp án");
  ...
  const handleChange_questionType = (event) => {
    setQestionType(event.target.value);
  };
            ...
            backgroundColor: "#ffffff",
              ...
              >
                ...
                <div style={{display: "flex", margin: "10px 0 50px 10%"}}>
                  <h3 style={{width: "10%"}}></h3>
                  <Button variant="outlined" color="success" type="submit" style={{margin: "0 20px 0 0", width: "10%"}}>
                    Lưu câu hỏi
                  </Button>
                  <Button variant="outlined" color="error" style={{margin: "0 0 0 20px", width: "10%"}} onClick={() => {navigate('/dashboard')}}>
                    Huỷ
                  </Button>
                </div>
              </form>
